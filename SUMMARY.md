**Synthetic plants** (Synthetic RGB-D data for plant segmentation) is a dataset for semantic segmentation and instance segmentation tasks. It is applicable or relevant across various domains.
